...
const SAMPLE_INPUT_CASE_811 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000301",
    "taxRegime": "AMMINISTRATO"
  },
  "clientInitialState": {
    "year": 2026,
  ...
  "events": [
    {
      ...
      "accountGroupId": "IT000301",
      "fee": 0.0,
      "transactionTimestamp": "2026-05-05T03:00:00+00:00",
    ...
    },
    {
      ...
      "accountGroupId": "IT000301",
      "fee": 0.0,
      "transactionTimestamp": "2026-05-20T03:00:00+00:00",
    ...
    },
    {
      ...
      "transactionTimestamp": "2026-05-21T03:00:00+00:00",
...
const SAMPLE_INPUT_CASE_812 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000302",
    "taxRegime": "AMMINISTRATO"
  },
  "clientInitialState": {
    "year": 2026,
  ...
  "events": [
    {
      ...
      "accountGroupId": "IT000302",
      "fee": 0.0,
      "transactionTimestamp": "2026-06-01T03:00:00+00:00",
    ...
    },
    {
      ...
      "accountGroupId": "IT000302",
      "fee": 0.0,
      "transactionTimestamp": "2026-06-10T03:00:00+00:00",
    ...
    },
    {
      ...
      "fee": 0.0,
      "correctedTriggerReference": "2",
      "transactionTimestamp": "2026-06-11T03:00:00+00:00",
...
const SAMPLE_INPUT_CASE_813 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000401",
    "taxRegime": "DICHIARATIVO"
  },
  "clientInitialState": {
    "year": 2026,
...
const SAMPLE_INPUT_CASE_814 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000402",
    "taxRegime": "DICHIARATIVO"
  },
  "clientInitialState": {
    "year": 2026,
...
const SAMPLE_INPUT_CASE_831 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000531",
    "taxRegime": "AMMINISTRATO"
  },
  "clientInitialState": {
    "year": 2026,
  ...
  "events": [
    {
      ...
      "accountGroupId": "IT000531",
      "fee": 0.0,
      "transactionTimestamp": "2026-03-01T03:00:00+00:00",
    ...
    },
    {
      ...
      "accountGroupId": "IT000531",
      "fee": 0.0,
      "transactionTimestamp": "2026-04-01T03:00:00+00:00",
    ...
    },
    {
      ...
      "fee": 0.0,
      "correctedTriggerReference": "2",
      "transactionTimestamp": "2026-04-04T03:00:00+00:00",
...
const SAMPLE_INPUT_CASE_832 = `{
  "clientData": {
    "countryOfTaxResidency": "IT",
    "accountGroupId": "IT000532",
    "taxRegime": "AMMINISTRATO"
  },
  "clientInitialState": {
    "year": 2026,
  ...
  "events": [
    {
      ...
      "accountGroupId": "IT000532",
      "fee": 0.0,
      "transactionTimestamp": "2026-12-20T03:00:00+00:00",
      "valueDate": "2026-12-20"
    },
    {
      "triggerReference": "2",
      "isin": "IT0004967292",
      ...
      "accountGroupId": "IT000532",
      "fee": 0.0,
      "transactionTimestamp": "2026-12-29T03:00:00+00:00",
      "valueDate": "2026-12-29"
    },
    {
      "triggerReference": "3",
      "isin": "IT0004967292",
      ...
      "fee": 0.0,
      "correctedTriggerReference": "2",
      "transactionTimestamp": "2027-01-03T03:00:00+00:00",
      "valueDate": "2027-01-03"
    },
    {
      "triggerReference": "4",
      "isin": "IT0004967292",
...
const CASES = {
  ...
  "scope8-case811": {
    label: "Scope 8 - Case 8.1.1",
    description: "Administrative reversal cancels a gain sell and restores state.",
    tags: ["AMMINISTRATO", "Reversal", "Gain", "Sell cancel"],
    sample: SAMPLE_INPUT_CASE_811,
  },
  "scope8-case812": {
    label: "Scope 8 - Case 8.1.2",
    description: "Administrative reversal cancels a loss sell and removes loss pot.",
    tags: ["AMMINISTRATO", "Reversal", "Loss", "Loss pot"],
    sample: SAMPLE_INPUT_CASE_812,
  },
  "scope8-case813": {
    label: "Scope 8 - Case 8.1.3",
    description: "Dichiarativo reversal cancels a gain sell and resets fiscal debt.",
    tags: ["DICHIARATIVO", "Reversal", "Gain", "Fiscal debt"],
    sample: SAMPLE_INPUT_CASE_813,
  },
  "scope8-case814": {
    label: "Scope 8 - Case 8.1.4",
  ...
  "scope8-case831": {
    label: "Scope 8 - Case 8.3.1",
    description: "Reversal restores a loss pot previously consumed by gain offset.",
    tags: ["AMMINISTRATO", "Reversal", "Loss pot", "Offset restore"],
    sample: SAMPLE_INPUT_CASE_831,
  },
  "scope8-case832": {
    label: "Scope 8 - Case 8.3.2",
    description: "Reversal and correction across year boundary (Dec/Jan).",
